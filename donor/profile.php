...
<h2 class="logo">MY PROFILE</h2>
    <form method="post" name="view">
        <b class=head>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDONOR DETAILS</b><br><br>
            <?php
			...
			?>
                              <tr>
                                ...
                                <td><a class="button" href="updatepatient.php?requestid=<?php echo $row["id"];?>" onclick="return confirm('Are you sure you want to update patient details ?');">Update </a></td>
                              </tr>
                    <?php
						}
						}
            ...
            ?>
              ...
              <div class="search">
                ...
                <td><a class="button1" href="displayrecipients.php?requestid=<?php echo $row["id"];?>" onclick="return confirm('Searching for matching recipients');">Search recipients</a></td>
              <br><br>
              </div>
            ...
            <!--- <div class="recipient">
              &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp                          
                <td><a class="button2" href="recipients.php?requestid=<?php echo $row["id"];?>" onclick="return confirm('View details of your recipients ?');">My recipients</a></td>
